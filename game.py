...
BG_IMG = pygame.transform.scale(pygame.image.load(os.path.join("imgs", "bg.png")), (WIN_WIDTH, WIN_HEIGHT + 150))
...
class Pipe:
    ...
    def set_height(self):
        self.height = random.randrange(40, 370)
...
def eval_genomes(genomes, config):
    ...
    while run:
        ...
        for x in sorted(dead_gen, reverse = True):
            birds.pop(x)
            nets.pop(x)
            ge.pop(x)
